...
dependencies {
    ...
    documentation("com.squareup.okhttp3:okhttp:5.4.0") {
        attributes {
            attribute(
    ...
    testImplementation("ch.qos.logback:logback-core:1.6.2")
    ...
    androidTestImplementation("com.squareup.okhttp3:mockwebserver3-junit4:5.4.0")
}
