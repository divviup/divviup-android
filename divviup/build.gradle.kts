...
dependencies {
    ...
    constraints {
        ...
        androidLintTool("org.bouncycastle:bcpkix-jdk18on:1.85")
        androidLintTool("org.bouncycastle:bcprov-jdk18on:1.85")
        androidLintTool("org.bouncycastle:bcutil-jdk18on:1.85")
    }
}
