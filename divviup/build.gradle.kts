...
dependencies {
    ...
    documentation("com.squareup.okhttp3:okhttp:5.2.1") {
        attributes {
            attribute(
    ...
    androidTestImplementation("com.squareup.okhttp3:mockwebserver3:5.2.1")
    androidTestImplementation("com.squareup.okhttp3:mockwebserver3-junit4:5.2.1")
}
